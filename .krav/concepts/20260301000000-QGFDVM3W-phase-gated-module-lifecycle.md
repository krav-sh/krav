...
Each module in Krav tracks its current lifecycle phase independently. Phases gate what work can happen and when a module can advance, ensuring that architecture settles before design begins, design settles before coding begins, and so on.
